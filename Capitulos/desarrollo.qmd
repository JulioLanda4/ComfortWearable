...
XXX revisar cantidades en datasheet y redacción XXX
...
El microcontrolador XIAO ESP32C3 presenta un consumo promedio de 74.7 mA durante su operación activa, mientras que la pantalla XIAO Round Display demanda aproximadamente 70 mA. Por su parte, el sensor GY-906 tiene un consumo de corriente bajo, en el rango de 1 a 2 mA, el sensor MAX30102 consume entre 0.6 y 1.2 mA durante la medición de la frecuencia cardíaca. Adicionalmente, el motor vibrador registra un consumo estimado de 84 mA, dependiendo de la intensidad de la vibración y la carga aplicada.
