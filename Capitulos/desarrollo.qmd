...
![Diagrama funcional de bloques del reloj inteligente.](../Imagenes/DiagramaBloques.png){#fig-DiagramaBloques width=80%}
...
En el artículo "IoT smartwatch based on open technologies for the collection of thermal comfort data" de @Landa2025, se presenta información detallada sobre el diseño y los pasos para la construcción del reloj inteligente.

La @fig-relojarmado muestra el reloj completamente ensamblado desde distintas vistas, en donde se observan los sensores de temperatura de la piel (GY-906) y de frecuencia cardiaca (MAX30102), la pantalla, el puerto de carga y el interruptor de encendido y apagado.

![Reloj inteligente ensamblado: a) vista frontal del reloj inteligente, b) vista superior del reloj inteligente, c) vista inferior del reloj inteligente.](../Imagenes/Reloj%20armado.png){#fig-relojarmado}

La @fig-relojfuncionando presenta el reloj inteligente en funcionamiento, mostrando su ajuste en la muñeca del usuario, la interfaz gráfica del reloj y la funcionalidad práctica de su diseño.
