...
| **Nombre del sensor**        | **Tipo de sensor**                  | **Rango de temperatura**           | **Precisión**                         | **Comunicación**                      | **Dimensión**  |
|---------------------------|-------------------------------------|------------------------------------|---------------------------------------|---------------------------------------|-------------|
...
: Características de sensores de temperatura compatibles con la placa XIAO ESP32C3. {#tbl-temp .hover .sm}
...
La XIAO ESP32C3 presenta una demanda de corriente promedio de 74.7 mA durante su operación activa [@xiaoesp32c3], mientras que la pantalla XIAO Round Display demanda aproximadamente 37.0 mA [@xiaodisplay]. Por su parte, el sensor GY-906 tiene una demanda de corriente baja, en el rango de 1.0 a 2.0 mA [@mlx90614_datasheet], el sensor MAX30102 requiere entre 0.6 y 1.2 mA durante la medición de la frecuencia cardíaca [@max30102_datasheet]. Adicionalmente, el motor vibrador presenta una corriente requerida aproximada de 84.0 mA [@uelectronics_vibration_motor], dependiendo de la intensidad de la vibración y la carga aplicada.

La demanda de corriente total del dispositivo en condiciones de operación máxima puede alcanzar 200.0 mA aproximadamente. Sin embargo, este nivel es poco probable alcanzarse durante el uso típico del dispositivo, ya que, durante la mayor parte del tiempo los sensores y la pantalla permanecen inactivos y solo se encenderán al momento de llevar a cabo sus mediciones; el motor vibrador se enciende únicamente por breves periodos cada hora. Con el fin de asegurar autonomía del dispositivo y evitar interrupciones en su funcionamiento, se selecciona una batería con un voltaje nominal de 3.7 V y una capacidad de 650.0 mAh. Estas características satisfacen los requisitos energéticos, permitiendo el uso prolongado del reloj inteligente. Además, la batería seleccionada cumple en tamaño y peso, ajustándose adecuadamente al diseño del dispositivo.

La @tbl-componentes-seleccionados muestra todos los componentes seleccionados para el desarrollo del dispositivo, entre los que se incluye el interruptor de encendido SS12D00, que es un interruptor con dimensiones de 3.5 x 8.5 mm. Este componente, debido a su tamaño compacto, se adapta al diseño del reloj inteligente.
...
| Interruptor SS12D00        | Interruptor de encendido y apagado del reloj inteligente   |
...
Adicional, hay una cuarta pieza que es un seguro para fijar el interruptor de encendido. Esta se coloca por encima del interruptor una vez esté colocado en su posición en la pieza central. El seguro ensambla por presión a la parte central de la carcasa y deja fijo el interruptor.

En la @fig-partescase se observan las tres partes principales de la carcasa.
...
En el artículo de @Landa2024 (en revisión), se presenta información detallada sobre el diseño y los pasos para la construcción del dispositivo."
